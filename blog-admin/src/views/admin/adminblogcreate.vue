<template>
  <a-form :model="formState" :label-col="labelCol" :wrapper-col="wrapperCol">
      ...
      <a-form-item label="文章封面URL" >
        <a-input v-model:value="formState.img" placeholder="Please enter image URL" />
      </a-form-item>
      ...
      <a-form-item label="文章简介">
        <a-textarea v-model:value="formState.description" placeholder="Please enter description" />
      </a-form-item>
...
const onSubmit = () => {
  formState.value.content = text.value;
  console.log(formState.value)
  addBlog(formState.value).then(res => {
...
watch(value, () => {
  formState.value.categoryId = toRaw(value.value[0]);
});
</script>